...
public class startHindi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_hindi);
        ...
        continueb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mobilenum.length() != 13){
                    Toast.makeText(startHindi.this, "मोबाइल नंबर 10 अंकों का होना चाहिए", Toast.LENGTH_SHORT).show();
                    return;
                }
                otpSend();
            }
    ...
    public void otpSend(){
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                Toast.makeText(startHindi.this, "ओटीपी नहीं भेजा जा सका", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                Intent intent = new Intent(startHindi.this,otphindi.class);
                startActivity(intent);
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setActivity(startHindi.this)                 // (optional) Activity for callback binding
